...
# creates a plot of Global Active Power vs Time
# The output is saved to a plot2.png file in the working directory.
#
#
###############################################################################
...
plot2 <- function(filepath  = "household_power_consumption.txt") {
    ...
    plot(plot_data$Time, plot_data$Global_active_power, xlab = "", ylab = "Global Active Power (kilowatts)", type = "l")
    dev.off()
